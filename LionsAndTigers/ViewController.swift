...
//  LionsAndTigers
//
//  Created by Saurav Sharma on 11/24/14.
...
class ViewController: UIViewController {
  ...
  override func viewDidLoad() {
    ...
    println("My tiger's name is \(myTiger.name), his breed is \(myTiger.breed), his age is \(myTiger.age)")
    ...
    femaleLionCub.subspecies = "Trasnvaal"
